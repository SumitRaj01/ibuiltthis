  ...
  return (
    <div className="py-16">
      <div className="wrapper">
        <Link
          href="/explore"
          className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-8 tranistion-colors"
        >
          <ArrowLeftIcon className="sieze-4" /> Back to Explore
        </Link>
